...
public static class FastEndpointsConfigurationExtensions
{
        ...
        string signingKey)
    {
        ...
        services.AddAuthorization()
            ...
            .SwaggerDocument(options =>
            {
                ...
                {
                    s.Converters.Add(_jsonStringEnumConverter);
    ...
    {
        app.UseAntiforgeryFE(additionalContentTypes: [MediaTypeNames.Application.Json]);
        ...
        app.UseFastEndpoints(c =>
        {
            ...
            c.Serializer.Options.Converters.Add(_jsonStringEnumConverter);

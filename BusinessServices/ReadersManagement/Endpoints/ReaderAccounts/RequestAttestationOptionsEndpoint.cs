...
public class RequestAttestationOptionsEndpoint : Endpoint<RequestAttestationOptionsDto, ApiResponse?>
{
    ...
    public override void Configure()
    {
        ...
        Description(b => b
            ...
            .Accepts<RequestAttestationOptionsDto>(MediaTypeNames.Application.Json)
            .Produces<ApiResponseForOpenApi<CredentialCreateOptions>>((int)HttpStatusCode.OK, MediaTypeNames.Application.Json)

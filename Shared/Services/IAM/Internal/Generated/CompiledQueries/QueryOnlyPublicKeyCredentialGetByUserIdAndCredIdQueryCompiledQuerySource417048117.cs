...
namespace Marten.Generated.CompiledQueries
{
    ...
    public class QueryOnlyPublicKeyCredentialGetByUserIdAndCredIdQueryCompiledQuery417048117 : Marten.Internal.CompiledQueries.ComplexCompiledQuery<snowcoreBlog.Backend.IAM.Core.Entities.Fido2PublicKeyCredentialEntity, snowcoreBlog.Backend.IAM.CompiledQueries.Marten.PublicKeyCredentialGetByUserIdAndCredIdQuery>
    {
        ...
        public QueryOnlyPublicKeyCredentialGetByUserIdAndCredIdQueryCompiledQuery417048117(Marten.Linq.QueryHandlers.IMaybeStatefulHandler inner, snowcoreBlog.Backend.IAM.CompiledQueries.Marten.PublicKeyCredentialGetByUserIdAndCredIdQuery query) : base(inner, query)
        {
            _inner = inner;
            _query = query;
        }
        ...
        {
            var parameters1 = builder.AppendWithParameters(@"select d.data from public.mt_doc_fido2publickeycredentialentity as d where (d.mt_deleted = False and CAST(d.data ->> 'UserId' as uuid) = ^ and CAST(d.data ->> 'PublicKeyCredentialId' as jsonb) is null) LIMIT ^;", '^');
    ...
    public class QueryOnlyPublicKeyCredentialGetByUserIdAndCredIdQueryCompiledQuerySource417048117 : Marten.Internal.CompiledQueries.CompiledQuerySource<snowcoreBlog.Backend.IAM.Core.Entities.Fido2PublicKeyCredentialEntity, snowcoreBlog.Backend.IAM.CompiledQueries.Marten.PublicKeyCredentialGetByUserIdAndCredIdQuery>
    {
        ...
        {
            return new Marten.Generated.CompiledQueries.QueryOnlyPublicKeyCredentialGetByUserIdAndCredIdQueryCompiledQuery417048117(_maybeStatefulHandler, query);
        }

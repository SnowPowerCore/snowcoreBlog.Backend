...
namespace Marten.Generated.CompiledQueries
{
    ...
    public class IdentityOnlyPublicKeyCredentialGetByUserIdAndCredIdQueryCompiledQuery417048117 : Marten.Internal.CompiledQueries.ClonedCompiledQuery<snowcoreBlog.Backend.IAM.Core.Entities.Fido2PublicKeyCredentialEntity, snowcoreBlog.Backend.IAM.CompiledQueries.Marten.PublicKeyCredentialGetByUserIdAndCredIdQuery>
    {
        ...
        public IdentityOnlyPublicKeyCredentialGetByUserIdAndCredIdQueryCompiledQuery417048117(Marten.Linq.QueryHandlers.IMaybeStatefulHandler inner, snowcoreBlog.Backend.IAM.CompiledQueries.Marten.PublicKeyCredentialGetByUserIdAndCredIdQuery query, Marten.Linq.QueryStatistics statistics) : base(inner, query, statistics)
        {
            _inner = inner;
            _query = query;
    ...
    public class IdentityOnlyPublicKeyCredentialGetByUserIdAndCredIdQueryCompiledQuerySource417048117 : Marten.Internal.CompiledQueries.CompiledQuerySource<snowcoreBlog.Backend.IAM.Core.Entities.Fido2PublicKeyCredentialEntity, snowcoreBlog.Backend.IAM.CompiledQueries.Marten.PublicKeyCredentialGetByUserIdAndCredIdQuery>
    {
        ...
        {
            return new Marten.Generated.CompiledQueries.IdentityOnlyPublicKeyCredentialGetByUserIdAndCredIdQueryCompiledQuery417048117(_maybeStatefulHandler, query, null);
        }

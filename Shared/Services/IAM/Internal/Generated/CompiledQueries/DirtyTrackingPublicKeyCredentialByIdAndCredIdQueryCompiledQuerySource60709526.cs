...
{
    // START: DirtyTrackingPublicKeyCredentialByIdAndCredIdQueryCompiledQuery60709526
    public class DirtyTrackingPublicKeyCredentialByIdAndCredIdQueryCompiledQuery60709526 : Marten.Internal.CompiledQueries.ComplexCompiledQuery<bool, snowcoreBlog.Backend.IAM.CompiledQueries.Marten.PublicKeyCredentialByIdAndCredIdQuery>
    {
        ...
        public DirtyTrackingPublicKeyCredentialByIdAndCredIdQueryCompiledQuery60709526(Marten.Linq.QueryHandlers.IMaybeStatefulHandler inner, snowcoreBlog.Backend.IAM.CompiledQueries.Marten.PublicKeyCredentialByIdAndCredIdQuery query) : base(inner, query)
        {
            _inner = inner;
            _query = query;
        }
    ...
    // END: DirtyTrackingPublicKeyCredentialByIdAndCredIdQueryCompiledQuery60709526
    
    
    // START: DirtyTrackingPublicKeyCredentialByIdAndCredIdQueryCompiledQuerySource60709526
    public class DirtyTrackingPublicKeyCredentialByIdAndCredIdQueryCompiledQuerySource60709526 : Marten.Internal.CompiledQueries.CompiledQuerySource<bool, snowcoreBlog.Backend.IAM.CompiledQueries.Marten.PublicKeyCredentialByIdAndCredIdQuery>
    {
        private readonly Marten.Linq.QueryHandlers.IMaybeStatefulHandler _maybeStatefulHandler;

        public DirtyTrackingPublicKeyCredentialByIdAndCredIdQueryCompiledQuerySource60709526(Marten.Linq.QueryHandlers.IMaybeStatefulHandler maybeStatefulHandler)
        {
        ...
        {
            return new Marten.Generated.CompiledQueries.DirtyTrackingPublicKeyCredentialByIdAndCredIdQueryCompiledQuery60709526(_maybeStatefulHandler, query);
        }

    }

    // END: DirtyTrackingPublicKeyCredentialByIdAndCredIdQueryCompiledQuerySource60709526

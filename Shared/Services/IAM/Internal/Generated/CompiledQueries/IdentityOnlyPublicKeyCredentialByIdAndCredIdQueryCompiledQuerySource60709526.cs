...
{
    // START: IdentityOnlyPublicKeyCredentialByIdAndCredIdQueryCompiledQuery60709526
    public class IdentityOnlyPublicKeyCredentialByIdAndCredIdQueryCompiledQuery60709526 : Marten.Internal.CompiledQueries.ComplexCompiledQuery<bool, snowcoreBlog.Backend.IAM.CompiledQueries.Marten.PublicKeyCredentialByIdAndCredIdQuery>
    {
        ...
        public IdentityOnlyPublicKeyCredentialByIdAndCredIdQueryCompiledQuery60709526(Marten.Linq.QueryHandlers.IMaybeStatefulHandler inner, snowcoreBlog.Backend.IAM.CompiledQueries.Marten.PublicKeyCredentialByIdAndCredIdQuery query) : base(inner, query)
        {
            _inner = inner;
            _query = query;
        }
    ...
    // END: IdentityOnlyPublicKeyCredentialByIdAndCredIdQueryCompiledQuery60709526
    
    
    // START: IdentityOnlyPublicKeyCredentialByIdAndCredIdQueryCompiledQuerySource60709526
    public class IdentityOnlyPublicKeyCredentialByIdAndCredIdQueryCompiledQuerySource60709526 : Marten.Internal.CompiledQueries.CompiledQuerySource<bool, snowcoreBlog.Backend.IAM.CompiledQueries.Marten.PublicKeyCredentialByIdAndCredIdQuery>
    {
        private readonly Marten.Linq.QueryHandlers.IMaybeStatefulHandler _maybeStatefulHandler;

        public IdentityOnlyPublicKeyCredentialByIdAndCredIdQueryCompiledQuerySource60709526(Marten.Linq.QueryHandlers.IMaybeStatefulHandler maybeStatefulHandler)
        {
        ...
        {
            return new Marten.Generated.CompiledQueries.IdentityOnlyPublicKeyCredentialByIdAndCredIdQueryCompiledQuery60709526(_maybeStatefulHandler, query);
        }

    }

    // END: IdentityOnlyPublicKeyCredentialByIdAndCredIdQueryCompiledQuerySource60709526

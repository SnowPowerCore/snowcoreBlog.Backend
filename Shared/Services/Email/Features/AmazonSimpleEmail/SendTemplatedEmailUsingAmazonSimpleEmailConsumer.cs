...
public class SendTemplatedEmailUsingAmazonSimpleEmailConsumer(IValidator<SendTemplatedEmail> validator,
                                                              IAmazonSimpleEmailServiceV2 simpleEmail) : IConsumer<SendTemplatedEmail>
{

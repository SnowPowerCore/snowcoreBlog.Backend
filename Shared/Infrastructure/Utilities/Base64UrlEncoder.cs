...
{
    private const string IDX10716 = "IDX10716: '{0}' must be greater than 0, was: '{1}'";
    private const string IDX10717 = "IDX10717: '{0} + {1}' must not be greater than {2}, '{3} + {4} > {5}'.";
    private const string IDX10400 = "IDX10400: Unable to decode: '{0}' as Base64url encoded string.";
...
#pragma warning restore CA2208 // Instantiate argument exceptions correctly
...
#endif
            throw LogHelper.LogExceptionMessage(new FormatException(LogHelper.FormatInvariant(IDX10400, strSpan.ToString())));
    ...
    public static string Decode(string arg) =>
        Encoding.UTF8.GetString(DecodeBytes(arg));
}